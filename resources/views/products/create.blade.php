    ...
    <div class="flex relative">
        ...
        <div class="w-full">
            ...
            <div class="w-full px-2">
                ...
                <form id="productForm" action="{{route('products.store')}}" class="mx-auto" method="post"
                        ...
                        <div class="flex-1">
                            ...
                            <fieldset class="fieldset">
                                ...
                                <div class="border max-w-24 min-h-24 max-h-24 mb-2">
                                    <img id="modalPreviewProduct" class="w-full h-full object-cover object-center"
                ...
                <div class="flex justify-between items-center my-3">
                    <button form="productForm" type="submit" class="btn btn-primary">Create Product</button>

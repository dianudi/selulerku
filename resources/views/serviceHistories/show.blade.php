            ...
            <div class="w-full px-2">
                ...
                <div class="w-full">
                        ...
                        <div class="card-body">
                                ...
                                <table class="table w-full">
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th>Rp.
                                                {{ number_format($serviceHistory->details->sum('price'), 2, ',', '.') }}
                                            </th>
                                        </tr>
                                    </tfoot>
                                </table>
                            ...
                            <div class="block md:hidden">
                                ...
                                <div class="text-right font-bold text-lg">Total: Rp.
                                    {{ number_format($serviceHistory->details->sum('price'), 2, ',', '.') }}</div>
                            </div>
                        </div>
                    </div>
                    <div class="md:hidden flex justify-around gap-2 my-4">
                        ...
                        <form action="{{ route('servicehistories.destroy', $serviceHistory) }}" method="post" class="flex-1">
                            @csrf
                            @method('DELETE')
